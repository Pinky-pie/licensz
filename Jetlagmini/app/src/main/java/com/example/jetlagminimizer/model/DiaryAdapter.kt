package com.example.jetlagminimizer.model
...
class DiaryAdapter(private val diary_list: MutableList<Diary>, private val listener: OnItemClickListener): RecyclerView.Adapter<DiaryViewHolder>() {
